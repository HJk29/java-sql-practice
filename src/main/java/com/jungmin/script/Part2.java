...
public class Part2 {
  ...
  */
  public static final String PART2_3 = "insert into users(username, email, password)" +
          " values('김준하', 'rlawnsgk22@gmail.com', 'wnddkd12')";
  ...
  */
  public static final String PART2_10 = "insert into posts(title, content, user_id, board_id, created_at)" +
          " Values('요즘 힘들다', '인생이 요즘 그냥 힘들다.', 1, 3, '2024-05-16')";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-11. 어느 board에도 속하지 않는 post의 모든 데이터를 찾기위한 SQL을 작성해주세요.")
  */
  public static final String PART2_11 = "select posts.* from posts where board_id is NULL";
  ...
  */
  public static final String PART2_13 = "select b.name from Posts p " +
          "join Boards b on b.board_id = p.board_id" +
          " join Users u on p.user_id = u.user_id where u.user_id = 1";
  ...
  */
  public static final String PART2_16 = "select u.username as username, COUNT(c.comment_id) AS CommentCount " +
          "from users u left join Comments c on u.user_id = c.user_id " +
          "group by u.username";
  ...
  */
  public static final String PART2_17 = "select b.name, COUNT(p.post_id) as PostCount " +
          "from Posts p right join Boards b on p.board_id = b.board_id " +
          "group by b.name";
  ...
  */
  public static final String PART2_18 = "select b.name, AVG(LENGTH(p.content)) AS AvgLength " +
          "from boards b left join Posts p on b.board_id = p.board_id " +
          "group by b.name";
  ...
  */
  public static final String PART2_19 = "select b.name, AVG(CHAR_LENGTH(p.content)) AS AvgLength " +
          "from boards b join Posts p on b.board_id = p.board_id " +
          "group by b.name";
